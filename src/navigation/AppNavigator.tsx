...
export default function AppNavigator() {
    return (
        ...
        <Stack.Navigator>
            ...
            <Stack.Screen name="StockDetail" component={StockDetailScreen} options={{ title: "Detail akcie" }} />
            <Stack.Screen name="AddTransaction" component={AddTransactionScreen} options={{ title: "Nová transakce" }} />
        </Stack.Navigator>
        </NavigationContainer>
    );
}
